...
Executive Authority authorized TNGD-BP-000 as the prerequisite foundation package. BP-000 established the canonical executable location, runtime boundary, persistence and migration locations, environment handling, build and test commands, deployment boundary, and repository validation requirements, then reached pilot review. BP-001 may now resume according to dependency order.